...
public class MeshDeformer : MonoBehaviour
{
    ...
    /* Deforms this mesh
       point: The point from which deformation of the mesh starts .Deforme olmaya baþladýðý nokta
       radius: The maximum radius to which the deformation affects .Deforme olacak alanýn çapý
